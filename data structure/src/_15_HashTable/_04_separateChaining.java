package _15_HashTable;// 해시 충돌 해결 - 분리 연결법

class SeparateChainingMain {
    public static void main(String[] args) {
        _04_separateChaining ht = new _04_separateChaining(11);
        ht.setValue(1, 10);
        ht.setValue(2, 20);
        ht.setValue(3, 30);
        ht.printHashTable();
...
public class _04_separateChaining {

    LinkedList[] table;

    _04_separateChaining(int length) {
