...
public class StudentList extends DoublyCircularLinkedList<Student>{
    ...
    String retriveReverseAll() // 학번 역순으로 전체 출력
    {
        String str = "";
    ...
    String retrieveAllFromCertainId(int id) // 특정 학번부터 전체 출력
    {
